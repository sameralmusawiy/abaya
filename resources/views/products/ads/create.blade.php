...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2" >
            <a href="{{ route('ads.index') }}" class="btn btn-light text-success shadow">رجوع <i class="bi bi-arrow-90deg-up"></i></a>
        </div>
    </div>
</div>
...
<div class="container bg-light mt-5 p-5">
    <div class="container">
        <form class="" style="text-align: right;" action="{!! route('ads.store') !!}" method="POST"  enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
