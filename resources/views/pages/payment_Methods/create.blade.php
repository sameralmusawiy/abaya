...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2" id="pageTitle">طرق الدفع</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="{{ route('payment_Methods.index') }}" class="btn text-success rounded shadow"> رجوع<i class="bi bi-arrow-return-left"></i></a>
        </div>
    </div>
</div>
<div class="container">
    <form class="row g-3" style="text-align: right;" action="{!! route('payment_Methods.store') !!}" method="POST"  enctype="multipart/form-data">
    @csrf
        <div class="col-md-6">
