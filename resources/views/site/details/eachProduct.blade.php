...
{{--  ////////////////////////////////////////////////////// الصور الصغيرة //////////////////////////////////////////////////////////////////////////  --}}
                ...
                <div style="background-color: red" class="msg"><br></div>
<br><br>
                        ...
                        @foreach($colors as $color)
                            @foreach ($images as $image)
                                ...
                                @for($i = 0; $i < $image->length; $i++)
                                    ...
                                    <button type="submit" class=" text-white" ><i style="background-color: {{ $color->value }};" class="bi bi-app"><img src="{{ URL::asset('/uploads/images/'.$image->photo[$i]) }}" alt="" style="width:100%" onclick="myFunctionProduct(this);" width = '60' height='85'></i></button>
                ...
                <div class="card-body">
                    ...
                    <h6>
                        ...
                        <form action="{!!route ('favorites.save' , $products_types->id)!!}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <button class="submit btn btn-dark mx-0 mt-1"><p class="small m-0">اضف الى قائمة المفضلات <i class="bi bi-heart"></i></p></button>
                        </form>
                    </h6>
                </div>
            </div>
